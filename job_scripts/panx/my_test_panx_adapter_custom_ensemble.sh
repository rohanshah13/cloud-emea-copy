...
LANG_ADAPTER_NAMES=( "pt/wiki@ukp,id/wiki@ukp,cs/wiki@ukp,hu/wiki@ukp,tr/wiki@ukp,en/wiki@ukp,zh_yue/wiki@ukp,fa/wiki@ukp,ka/wiki@ukp,hi/wiki@ukp" "pt/wiki@ukp,id/wiki@ukp,cs/wiki@ukp,hu/wiki@ukp,tr/wiki@ukp,en/wiki@ukp,zh_yue/wiki@ukp,fa/wiki@ukp,ka/wiki@ukp,is/wiki@ukp" "pt/wiki@ukp,id/wiki@ukp,cs/wiki@ukp,hu/wiki@ukp,tr/wiki@ukp,en/wiki@ukp,zh_yue/wiki@ukp,fa/wiki@ukp,ka/wiki@ukp,ru/wiki@ukp" )
ADAPTERS_LANGS=( "pt,id,cs,hu,tr,en,zh_yue,fa,ka,hi" "pt,id,cs,hu,tr,en,zh_yue,fa,ka,is" "pt,id,cs,hu,tr,en,zh_yue,fa,ka,ru" )
...
AW=${AWS[i]}
OUTPUT_DIR="$OUT_DIR/${TASK}/my-${MODEL}-MaxLen${MAX_LENGTH}_${TASK_ADAPTER_NAME}_ensemble_custom_corrected/"
mkdir -p $OUTPUT_DIR
echo $OUTPUT_DIR
for SEED in 1 2 3
do
