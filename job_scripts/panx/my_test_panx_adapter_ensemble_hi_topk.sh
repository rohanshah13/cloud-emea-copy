...
# LANG_ADAPTER_NAMES=( 'hi/wiki@ukp,zh_yue/wiki@ukp,hu/wiki@ukp,pt/wiki@ukp,cs/wiki@ukp,id/wiki@ukp,ka/wiki@ukp,lv/wiki@ukp,fa/wiki@ukp,tr/wiki@ukp' 'hi/wiki@ukp,fa/wiki@ukp,tr/wiki@ukp,cs/wiki@ukp,id/wiki@ukp,pt/wiki@ukp,hu/wiki@ukp,eu/wiki@ukp,ka/wiki@ukp,la/wiki@ukp' 'hi/wiki@ukp,id/wiki@ukp,cs/wiki@ukp,lv/wiki@ukp,ka/wiki@ukp,pt/wiki@ukp,hu/wiki@ukp,fa/wiki@ukp,tr/wiki@ukp,zh_yue/wiki@ukp' )
# ADAPTER_LANGS=( "hi,zh_yue,hu,pt,cs,id,ka,lv,fa,tr" "hi,fa,tr,cs,id,pt,hu,eu,ka,la" "hi,id,cs,lv,ka,pt,hu,fa,tr,zh_yue" )

#Top 5 based on hindi results for each seed
# LANG_ADAPTER_NAMES=( 'hi/wiki@ukp,zh_yue/wiki@ukp,hu/wiki@ukp,pt/wiki@ukp,cs/wiki@ukp' 'hi/wiki@ukp,fa/wiki@ukp,tr/wiki@ukp,cs/wiki@ukp,id/wiki@ukp' 'hi/wiki@ukp,id/wiki@ukp,cs/wiki@ukp,lv/wiki@ukp,ka/wiki@ukp' )
# ADAPTER_LANGS=( "hi,zh_yue,hu,pt,cs" "hi,fa,tr,cs,id" "hi,id,cs,lv,ka" )

#Top 3 based on hindi results for each seed
# LANG_ADAPTER_NAMES=( 'hi/wiki@ukp,zh_yue/wiki@ukp,hu/wiki@uk' 'hi/wiki@ukp,fa/wiki@ukp,tr/wiki@ukp' 'hi/wiki@ukp,id/wiki@ukp,cs/wiki@ukp' )
# ADAPTER_LANGS=( "hi,zh_yue,hu" "hi,fa,tr" "hi,id,cs" )

#Top 1 based on english results for each seed
LANG_ADAPTER_NAMES=( 'hi/wiki@ukp' 'hi/wiki@ukp' 'hi/wiki@ukp' )
ADAPTER_LANGS=( "hi" "hi" "hi" )
...
OUTPUT_DIR="$OUT_DIR/${TASK}/my-${MODEL}-MaxLen${MAX_LENGTH}_${TASK_ADAPTER_NAME}_ensemble_hi_top${K}/"
