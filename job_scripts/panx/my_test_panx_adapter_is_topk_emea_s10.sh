...
LANG_ADAPTER_NAMES=( "is/wiki@ukp,fa/wiki@ukp,pt/wiki@ukp,ka/wiki@ukp,en/wiki@ukp,zh_yue/wiki@ukp,de/wiki@ukp,cs/wiki@ukp,hu/wiki@ukp,fr/wiki@ukp" "is/wiki@ukp,ka/wiki@ukp,pt/wiki@ukp,hu/wiki@ukp,cs/wiki@ukp,de/wiki@ukp,en/wiki@ukp,hy/wiki@ukp,tr/wiki@ukp,zh_yue/wiki@ukp" "is/wiki@ukp,cs/wiki@ukp,pt/wiki@ukp,zh_yue/wiki@ukp,en/wiki@ukp,fa/wiki@ukp,es/wiki@ukp,de/wiki@ukp,ka/wiki@ukp,id/wiki@ukp" )
ADAPTER_LANGS=( "is,fa,pt,ka,en,zh_yue,de,cs,hu,fr" "is,ka,pt,hu,cs,de,en,hy,tr,zh_yue" "is,cs,pt,zh_yue,en,fa,es,de,ka,id" )

#Top 5 based on icelandic results for each seed
# LANG_ADAPTER_NAMES=( 'is/wiki@ukp,fa/wiki@ukp,pt/wiki@ukp,ka/wiki@ukp,en/wiki@ukp' 'is/wiki@ukp,ka/wiki@ukp,pt/wiki@ukp,hu/wiki@ukp,cs/wiki@uk' 'is/wiki@ukp,cs/wiki@ukp,pt/wiki@ukp,zh_yue/wiki@ukp,en/wiki@ukp' )
# ADAPTER_LANGS=( "is,fa,pt,ka,en" "is,ka,pt,hu,cs" "is,cs,pt,zh_yue,en" )

#Top 3 based on icelandic results for each seed
# LANG_ADAPTER_NAMES=( 'is/wiki@ukp,fa/wiki@ukp,pt/wiki@ukp' 'is/wiki@ukp,ka/wiki@ukp,pt/wiki@ukp' 'is/wiki@ukp,cs/wiki@ukp,pt/wiki@ukp' )
# ADAPTER_LANGS=( "is,fa,pt" "is,ka,pt" "is,cs,ptd" )
...
OUTPUT_DIR="$OUT_DIR/${TASK}/my-${MODEL}-MaxLen${MAX_LENGTH}_${TASK_ADAPTER_NAME}_emea_s10_is_top${K}/"
