...
LANGS="mr,bn,ta,fo,no,da,be,uk,bg,af,rw,yo"
# LANGS="af,bm,yo"
# LANGS="bn"
TRAIN_LANGS="en"
...
LANG_ADAPTER_NAME="cdo/wiki@ukp,bxr/wiki@ukp,mi/wiki@ukp,is/wiki@ukp,ja/wiki@ukp,wo/wiki@ukp,id/wiki@ukp,ru/wiki@ukp,qu/wiki@ukp,pt/wiki@ukp"
ADAPTER_LANG="cdo,bxr,mi,is,ja,wo,id,ru,qu,pt"

TASK_ADAPTER_NAME="ner"

EN_WEIGHT="_uniform"
DATA_DIR=$DATA_DIR/${TASK}/${TASK}_processed_maxlen${MAX_LENGTH}/
OUTPUT_DIR="$OUT_DIR/${TASK}/my-${MODEL}-MaxLen${MAX_LENGTH}_${TASK_ADAPTER_NAME}_ensemble_random/"
