...
ALL_LANGS="mr,bho,ta,fo,no,da,be,uk,bg,af,bm,yo"
# ALL_LANGS="en"
# REM_LANGS="be"
TRAIN_LANGS="en"
...
for SEED in 1 2 3
do
MY_TASK_ADAPTER="output/${TASK}/my-bert-base-multilingual-cased-LR1e-4-epoch${NUM_EPOCHS}-MaxLen128-TrainLangen_en_s${SEED}/checkpoint-best/ner/"
