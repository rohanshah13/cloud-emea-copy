...
LANG_ADAPTER_NAMES=( "pt/wiki@ukp,id/wiki@ukp,en/wiki@ukp,vi/wiki@ukp,tr/wiki@ukp,hu/wiki@ukp,zh_yue/wiki@ukp,cs/wiki@ukp,ka/wiki@ukp,hi/wiki@ukp" "pt/wiki@ukp,id/wiki@ukp,en/wiki@ukp,vi/wiki@ukp,tr/wiki@ukp,hu/wiki@ukp,zh_yue/wiki@ukp,cs/wiki@ukp,ka/wiki@ukp,is/wiki@ukp" "pt/wiki@ukp,id/wiki@ukp,en/wiki@ukp,vi/wiki@ukp,tr/wiki@ukp,hu/wiki@ukp,zh_yue/wiki@ukp,cs/wiki@ukp,ka/wiki@ukp,ru/wiki@ukp" )
ADAPTERS_LANGS=( "pt,id,en,vi,tr,hu,zh_yue,cs,ka,hi" "pt,id,en,vi,tr,hu,zh_yue,cs,ka,is" "pt,id,en,vi,tr,hu,zh_yue,cs,ka,ru" )
...
AW=${AWS[i]}
OUTPUT_DIR="$OUT_DIR/${TASK}/my-${MODEL}-MaxLen${MAX_LENGTH}_${TASK_ADAPTER_NAME}_ensemble_custom/"
mkdir -p $OUTPUT_DIR
echo $OUTPUT_DIR
for SEED in 1 2 3
do
