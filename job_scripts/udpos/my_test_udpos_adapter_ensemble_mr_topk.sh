...
#Top 10 based on marathi results for each seed (english task adapter)
LANG_ADAPTER_NAMES=( "vi/wiki@ukp,pt/wiki@ukp,hu/wiki@ukp,ka/wiki@ukp,zh_yue/wiki@ukp,tr/wiki@ukp,cs/wiki@ukp,id/wiki@ukp,am/wiki@ukp,fa/wiki@ukp" "zh_yue/wiki@ukp,tr/wiki@ukp,am/wiki@ukp,vi/wiki@ukp,cs/wiki@ukp,pt/wiki@ukp,hu/wiki@ukp,ka/wiki@ukp,eu/wiki@ukp,la/wiki@ukp" "zh_yue/wiki@ukp,vi/wiki@ukp,pt/wiki@ukp,ka/wiki@ukp,tr/wiki@ukp,cs/wiki@ukp,de/wiki@ukp,fa/wiki@ukp,hu/wiki@ukp,la/wiki@ukp" )
ADAPTER_LANGS=( "vi,pt,hu,ka,zh_yue,tr,cs,id,am,fa" "zh_yue,tr,am,vi,cs,pt,hu,ka,eu,la" "zh_yue,vi,pt,ka,tr,cs,de,fa,hu,la" )

#Top 10 based on marathi results for each seed (hindi task adapter)
...
#Top 5 based on marathi results for each seed
...
#Top 3 based on marathi results for each seed
...
#Top 1 based on marathi results for each seed
...
OUTPUT_DIR="$OUT_DIR/${TASK}/my-${MODEL}-MaxLen${MAX_LENGTH}_${TASK_ADAPTER_NAME}_ensemble_mr_top${K}/"
