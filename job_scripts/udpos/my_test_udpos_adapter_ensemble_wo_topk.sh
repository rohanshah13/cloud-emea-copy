...
LANG_ADAPTER_NAMES=( "wo/wiki@ukp,ht/wiki@ukp,zh_yue/wiki@ukp,cs/wiki@ukp,fa/wiki@ukp,ja/wiki@ukp,eu/wiki@ukp,hu/wiki@ukp,ka/wiki@ukp,ilo/wiki@ukp" "wo/wiki@ukp,ht/wiki@ukp,zh_yue/wiki@ukp,zh/wiki@ukp,am/wiki@ukp,el/wiki@ukp,ja/wiki@ukp,qu/wiki@ukp,hi/wiki@ukp,en/wiki@ukp" "wo/wiki@ukp,ht/wiki@ukp,ja/wiki@ukp,cs/wiki@ukp,ka/wiki@ukp,zh_yue/wiki@ukp,la/wiki@ukp,en/wiki@ukp,xmf/wiki@ukp,pt/wiki@ukp" )
ADAPTER_LANGS=( "wo,ht,zh_yue,cs,fa,ja,eu,hu,ka,ilo" "wo,ht,zh_yue,zh,am,el,ja,qu,hi,en" "wo,ht,ja,cs,ka,zh_yue,la,en,xmf,pt" )
...
OUTPUT_DIR="$OUT_DIR/${TASK}/my-${MODEL}-MaxLen${MAX_LENGTH}_${TASK_ADAPTER_NAME}_ensemble_wo_top${K}/"
