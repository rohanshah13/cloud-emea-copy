...
# ADAPTER_LANG="is"
ADAPTER_LANGS1=( "am" "ar" "bxr" "cdo" "cs" "de" "el" "en" "es" "et" "eu" "fa" "fi" "fr" "gn" "hi" "ht" "hu" "hy" "id" "ilo" "is" "ja" "jv" "ka" "ko" "kv" "la" "lv" "mhr" "mi" "my" "myv" "pt" "qu" "ru" "se" "sw" "tk" "tr" "vi" "wo" "xmf" "zh" "zh_yue" )
LANG_ADAPTER_NAMES1=( "am/wiki@ukp" "ar/wiki@ukp" "bxr/wiki@ukp" "cdo/wiki@ukp" "cs/wiki@ukp" "de/wiki@ukp" "el/wiki@ukp" "en/wiki@ukp" "es/wiki@ukp" "et/wiki@ukp" "eu/wiki@ukp" "fa/wiki@ukp" "fi/wiki@ukp" "fr/wiki@ukp" "gn/wiki@ukp" "hi/wiki@ukp" "ht/wiki@ukp" "hu/wiki@ukp" "hy/wiki@ukp" "id/wiki@ukp" "ilo/wiki@ukp" "is/wiki@ukp" "ja/wiki@ukp" "jv/wiki@ukp" "ka/wiki@ukp" "ko/wiki@ukp" "kv/wiki@ukp" "la/wiki@ukp" "lv/wiki@ukp" "mhr/wiki@ukp" "mi/wiki@ukp" "my/wiki@ukp" "myv/wiki@ukp" "pt/wiki@ukp" "qu/wiki@ukp" "ru/wiki@ukp" "se/wiki@ukp" "sw/wiki@ukp" "tk/wiki@ukp" "tr/wiki@ukp" "vi/wiki@ukp" "wo/wiki@ukp" "xmf/wiki@ukp" "zh/wiki@ukp" "zh_yue/wiki@ukp" )
...
OUTPUT_DIR="$OUT_DIR/${TASK}/my-weights-100-${MODEL}-MaxLen${MAX_LENGTH}_${TASK_ADAPTER_NAME}_${ADAPTER_LANG}/"
mkdir -p $OUTPUT_DIR
echo $OUTPUT_DIR
for SEED in 1 2 3
do
