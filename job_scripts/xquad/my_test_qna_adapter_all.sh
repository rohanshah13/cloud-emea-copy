...
ADAPTER_LANGS=( "ar" "cdo" "de" "el" "en" "es" "et" "gn" "hi" "ht" "id" "ilo" "is" "it" "ja" "jv" "mhr" "mi" "my" "qu" "ru" "sw" "ta" "th" "tk" "tr" "vi" "xmf" "zh" )
ADAPTER_NAMES=( "ar/wiki@ukp" "cdo/wiki@ukp" "de/wiki@ukp" "el/wiki@ukp" "en/wiki@ukp" "es/wiki@ukp" "et/wiki@ukp" "gn/wiki@ukp" "hi/wiki@ukp" "ht/wiki@ukp" "id/wiki@ukp" "ilo/wiki@ukp" "is/wiki@ukp" "it/wiki@ukp" "ja/wiki@ukp" "jv/wiki@ukp" "mhr/wiki@ukp" "mi/wiki@ukp" "my/wiki@ukp" "qu/wiki@ukp" "ru/wiki@ukp" "sw/wiki@ukp" "ta/wiki@ukp" "th/wiki@ukp" "tk/wiki@ukp" "tr/wiki@ukp" "vi/wiki@ukp" "xmf/wiki@ukp" "zh/wiki@ukp" )
...
MODEL_PATH=output/$SRC/my-${MODEL}_LR${LR}_EPOCH${NUM_EPOCHS}-MaxLen${MAXL}_batchsize${BATCH_SIZE}_gradacc${GRAD_ACC}_s${SEED}
