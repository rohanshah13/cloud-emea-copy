...
ADAPTER_LANGS=( "en,zh,es,ja,it,ta,ru,el,tr,ar" "ru,en,el,ta,de,it,es,id,th,et" "en,ru,zh,ja,el,es,id,it,de,ta" )
ADAPTER_NAMES=( "en/wiki@ukp,zh/wiki@ukp,es/wiki@ukp,ja/wiki@ukp,it/wiki@ukp,ta/wiki@ukp,ru/wiki@ukp,el/wiki@ukp,tr/wiki@ukp,ar/wiki@ukp" "ru/wiki@ukp,en/wiki@ukp,el/wiki@ukp,ta/wiki@ukp,de/wiki@ukp,it/wiki@ukp,es/wiki@ukp,id/wiki@ukp,th/wiki@ukp,et/wiki@ukp" "en/wiki@ukp,ru/wiki@ukp,zh/wiki@ukp,ja/wiki@ukp,el/wiki@ukp,es/wiki@ukp,id/wiki@ukp,it/wiki@ukp,de/wiki@ukp,ta/wiki@ukp" )
...
TRAIN_LANG="en"
PREDICT_LANGS="en,ar,de,el,es,hi,ru,th,tr,vi,zh"
# PREDICT_LANGS="en"
...
OUTPUT_DIR="$OUT_DIR/$TASK/my-${MODEL}-MaxLen${MAXL}_${TASK_ADAPTER_NAME}_ensemble_en_top${K}/"
