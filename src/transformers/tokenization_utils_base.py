...
class PreTrainedTokenizerBase(SpecialTokensMixin):
    ...
    def prepare_for_model(
        ...
        **kwargs
        ...
        # logger.info(f'My Truncation Strategy = {truncation_strategy == TruncationStrategy.LONGEST_FIRST}')
        # logger.info(f'Truncation Strategy = {TruncationStrategy.LONGEST_FIRST}')
        # logger.info(f'Truncation Strategy = {TruncationStrategy.ONLY_FIRST}')
        # logger.info(f'Truncation Strategy = {TruncationStrategy.ONLY_SECOND}')
